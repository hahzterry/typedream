 ...
 * TYPEDREAM_DATA_DIR can override this behavior when needed.
 */
const isVercel =
...
const defaultDataDir = isVercel
  ? path.join("/tmp", "typedream")
  : path.join(process.cwd(), "data");

export const DATA_DIR = path.resolve(
  process.env.TYPEDREAM_DATA_DIR ?? defaultDataDir
);
